...
export default function Cards(){
  return(
    ...
    <Projects title="Netflix Clone" description="A clone  Netflix homepage built using Next JS" />
    <Projects title="Ecommerce App" description="An e-commerce application built using NextJS" />
   </div>
   </div>
