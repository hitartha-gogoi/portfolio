...
export default function Projects({ title, description, image, link }){
  ...
  return(
    ...
    <div style={{ backgroundImage: `linear-gradient(to top, black, transparent), url('${image}')`, backgroundSize: "cover", backgroundPosition: "center center" }} className="h-full w-full object-contain rounded-2xl flex flex-col items-center justify-center">
